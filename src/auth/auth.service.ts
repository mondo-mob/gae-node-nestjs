...
export function decodeUserProfile(inputProfile: object): t.TypeOf<typeof userProfile> {
...
export function accountHolderEmail(profile: t.TypeOf<typeof userProfile>) {
...
export class AuthService {
  ...
  async validateUserGoogle(
    ...
    const profile = decodeUserProfile(inputProfile);
    const email = accountHolderEmail(profile);
